...
WebUI.setEncryptedText(findTestObject('Object Repository/Page_Login/input_Password_txt_password'), '7yOmT/a8m/M=')

WebUI.click(findTestObject('Object Repository/Page_Login/input_Password_btn_login'))

WebUI.click(findTestObject('Object Repository/Page_Login/div_Wrong password'))

WebUI.verifyTextPresent('Wrong password!', false)
