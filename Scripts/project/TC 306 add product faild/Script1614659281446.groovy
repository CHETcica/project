...
WebUI.doubleClick(findTestObject('Object Repository/Page_Cactus/button_'))

WebUI.click(findTestObject('Object Repository/Page_Cactus/button_'))

WebUI.verifyTextNotPresent('Carts', false)
