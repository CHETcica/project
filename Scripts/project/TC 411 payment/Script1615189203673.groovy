...
WebUI.click(findTestObject('Object Repository/Page_Cactus/a_Shop'))

WebUI.click(findTestObject('Object Repository/Page_Cactus/button_Add to Cart'))

WebUI.click(findTestObject('Object Repository/Page_Cactus/button_Add to Cart'))

WebUI.click(findTestObject('Object Repository/Page_Cactus/a_Payment'))

WebUI.click(findTestObject('Object Repository/Page_Document/button_submit'))

WebUI.verifyTextPresent('Payment completed', false)
